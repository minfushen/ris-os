...
_SOURCES_SEED: list[DataDictionarySource] = [
    # 风险数据集市 · 8 大变量域（对照《项目实施计划书》：客户/贷款/还款/信用卡/资产负债/交易/征信/三方）
    DataDictionarySource(
        id="DS201",
        name="客户信息域 · ECIF 客户主档",
        category="客户",
        refresh="实时",
    ...
    DataDictionarySource(
        id="DS208",
        name="三方数据域 · 工商/司法/税务/企查查",
        category="三方",
        refresh="T+1",
        connection_status="error",
        last_sync_at="2026-03-31 23:00",
    ),
]
